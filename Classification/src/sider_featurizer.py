...
def featurizer(df: pd.DataFrame,methods: list=None, mol_col: str = 'Molecule', fpSize: int = 2048, concatenate: bool = False) -> Union[pd.DataFrame, dict]:
    """
    ...
    if concatenate:
        ...
        print(f"Total features added: {df_rdkit_features.shape[1]} rdkit + {df_mf_features.shape[1]} Morgan")
        return df_concat
